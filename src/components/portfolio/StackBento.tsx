...
export const SectionHeader = ({
  ...
  <div className="max-w-2xl">
    <div className="inline-block rounded-md bg-primary/15 px-2 py-1 font-mono text-sm font-medium text-primary backdrop-blur-sm">
      {kicker}
    </div>
    <h2 className="mt-3 font-mono text-3xl font-bold tracking-tight text-foreground md:text-5xl">
      {title}
    </h2>
    {subtitle && <p className="mt-3 text-base text-foreground/75 md:text-lg">{subtitle}</p>}
  </div>
);
